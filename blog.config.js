...
const BLOG = {
      ...
      NOTION_PAGE_ID:
            process.env.NOTION_PAGE_ID || '48ff3fa0f3b24bd39e610a62eb70b133',
      ...
      GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个程序员, Hi，我是一个打工人,Hi，我是一个超级个体的幼体,欢迎来到我的博客🎉',
      ...
      CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'beyonds99@outlook.com', // 邮箱地址 例如mail@tangly1024.com
      CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
      CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
      CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/andy-brain', // 你的github个人主页 例如 https://github.com/tangly1024
      CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
      CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
      CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
      CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/1896323071', // B站主页
      ...
      BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '备案中...', // 备案号 闽ICP备XXXXXXX
      ...
      COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || 'andy-brain', // 你的用户名 e.g tangly1024
      COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || 'andy-brain', // 管理员用户名、一般是自己 e.g 'tangly1024'
      COMMENT_GITALK_CLIENT_ID:
            process.env.NEXT_PUBLIC_COMMENT_GITALK_CLIENT_ID || 'd1c4c9a720bd4a10f262', // e.g 20位ID ， 在gitalk后台获取
      COMMENT_GITALK_CLIENT_SECRET:
            process.env.NEXT_PUBLIC_COMMENT_GITALK_CLIENT_SECRET || 'e1f7a850ce7363962c8ee27b62b04ca0a8339643', // e.g 40位ID， 在gitalk后台获取
